...
var ControllerUnit = _react2.default.createClass({
  ...
  render: function render() {
    ...
    return _react2.default.createElement('span', { className: controlelrUnitClassName, onClick: this.handleClick });
  }
});

var GalleryByReactApp = _react2.default.creatClass({
  ...
  render: function render() {
    ...
    imageDatas.forEach(function (value, index) {
      ...
      imgFigures.push(_react2.default.createElement(ImgFigure, { key: index, data: value, ref: 'imgFigure' + index, arrange: this.state.imgsArrangeArr[index], inverse: this.inverse(index), center: this.center(index) }));

      controllerUnits.push(_react2.default.createElement(ControllerUnit, { key: index, arrange: this.state.imgsArrangeArr[index], inverse: this.inverse(index), center: this.center(index) }));
    }.bind(this));
...
exports.default = GalleryByReactApp;